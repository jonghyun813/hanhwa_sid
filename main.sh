...
MODE="er"
DATASET="VOC_10_10" # cifar10, cifar100, tinyimagenet, imagenet
SIGMA=10
REPEAT=1
INIT_CLS=100
...
if [ "$DATASET" == "VOC_10_10" ]; then
    ...
    MODEL_NAME="resnet18" EVAL_PERIOD=100
    BATCHSIZE=32; LR=3e-4 OPT_NAME="SGD" SCHED_NAME="default" IMP_UPDATE_PERIOD=1

elif [ "$DATASET" == "imagenet" ]; then
    MEM_SIZE=1281167 ONLINE_ITER=0.03125
    MODEL_NAME="resnet18" EVAL_PERIOD=1000
    BATCHSIZE=1024; LR=3e-4 OPT_NAME="SGD" SCHED_NAME="default" IMP_UPDATE_PERIOD=10
