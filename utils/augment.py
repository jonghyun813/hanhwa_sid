...
def get_transform(dataset, transform_list, method_name, transform_on_gpu=False, input_size=None, ccldc=False):
    ...
    if transform_on_gpu:
        ...
        if "xder" in method_name:
            ...
            transform_1 = transforms.Compose(
                [
                    transforms.RandomResizedCrop(size=(inp_size, inp_size), scale=(0.6, 1.)),
                    transforms.RandomHorizontalFlip(),
                    transforms.ConvertImageDtype(torch.float32),
                ]
            )
    ...
    if ccldc:
        return train_transform, test_transform, cpu_transform, n_classes, transform_1, transform_2, transform_3, base_transform, normalize
    else:
...
def get_statistics(dataset: str):
    ...
    mean = {
        ...
        "5_dataset": (0.3704, 0.3703, 0.3901),
    ...
    std = {
        ...
        "EMNIST": (0.3081,),
        "FashionMNIST": (0.3081,),
        "5_dataset": (0.2269, 0.2299, 0.2258),
